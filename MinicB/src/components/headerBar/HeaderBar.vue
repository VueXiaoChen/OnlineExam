<template>
  <div class="header-bar" :class="isFixHeaderBar ? 'slide-down' : ''">
    ...
    <div class="right-entry">
      ...
      <div class="v-popover-wrap">
        <VPopover :pop-style="headerStore.isLogin ? 'padding-top: 17px; margin-left: -100px;' : 'padding-top: 17px;'">
          <template #reference>
            <div class="right-entry--outside" @click="headerStore.isLogin ? noPage() : dialogVisible = true">
      ...
      <div class="v-popover-wrap">
        <VPopover :pop-style="headerStore.isLogin ? 'padding-top: 17px; margin-left: -50px;' : 'padding-top: 17px;'">
          <template #reference>
            <div class="right-entry--outside" @click="headerStore.isLogin ? noPage() : dialogVisible = true">
