...
import { useChannelStore } from '../../stores/useChannelStore' // 假设您有一个channelStore
    ...
    <div class="header-channel">
        ...
        <div class="right-channel-container">
            ...
            <div class="channel-items__left" v-if="channels.length !== 0">
                <!-- 番剧 -->
                <VPopover class="channel-link" placement="top" pop-style="z-index: 2000; cursor: default;">
                    <template #reference>
                ...
                <VPopover class="channel-link"
                    ...
                    pop-style="z-index: 2000; cursor: default;"
                >
                    <template #reference>
                ...
                >
                    <template #reference>
                        <div id="channel-entry-more" class="channel-entry-more__link">
                            ...
                            <i class="iconfont icon-xiajiantou" :class="{ 'arrow-down': isMoreOpen }"></i>
                        </div>
                    </template>
                    <template #content>
