<template>
    <div class="v-avatar" :style="avatarStyle">
        <img :src="img" :alt="altText" class="avatar-img">
        <span class="avatar-icon" :class="avatarIconClass">
            <svg v-if="auth === 1" t="1700121982187" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" :width="iconSize" :height="iconSize">
                <path d="M0 512a512 512 0 1 0 1024 0A512 512 0 1 0 0 512z" fill="#FFFFFF"></path>
                <path d="M93.09 512a418.91 418.91 0 1 0 837.82 0 418.91 418.91 0 1 0-837.82 0z" fill="#FFC62E"></path>
                <path
            ...
            <svg v-if="auth === 2" t="1700122376038" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" :width="iconSize" :height="iconSize">
                <path d="M0 512a512 512 0 1 0 1024 0A512 512 0 1 0 0 512z" fill="#FFFFFF"></path>
                <path d="M93.09 512a418.91 418.91 0 1 0 837.82 0 418.91 418.91 0 1 0-837.82 0z" fill="#4AC7FF"></path>
                <path
                    d="M474.112 763.95a33.28 33.28 0 0 1-14.057 4.05 21.039 21.039 0 0 1-21.318-20.806 19.55 19.55 0 0 1 1.21-5.865l40.495-187.438-167.657 0.326a21.225 21.225 0 0 1-21.876-20.806 20.433 20.433 0 0 1 9.495-16.85l250.182-255.767c4.608-2.793 9.542-4.747 14.662-4.794a21.132 21.132 0 0 1 21.364 20.852 19.968 19.968 0 0 1-2.792 9.775l-40.216 184.32h167.843a21.178 21.178 0 0 1 21.644 20.852 20.294 20.294 0 0 1-9.495 16.943L474.112 763.95z"
                    fill="#FFFFFF"></path>
            </svg>
...
const avatarIconClass = computed(() => `avatar-size-${props.size}`);

const iconSize = computed(() => {
  // 根据头像大小设置认证图标大小
  if (props.size >= 60) return 16;
  if (props.size >= 48) return 14;
  return 12;
});
