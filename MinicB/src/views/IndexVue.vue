...
<template>
    <div class="index">
        <div class="large-header">
            <HeaderBar :is-fix-header-bar="isFixHeaderBar"></HeaderBar>
            <header>
                <div class="view">
...
const initHeader = () => {
    ...
    handleMouseMove = (e) => {
        ...
        if (
            ...
            let percentage:any = (e.clientX - startingPoint) / window.outerWidth + 0.5
...
const handleNum = (number) => {
    return utilsHandleNum(number)
}

// 处理投稿时间
const handleDate = (date) => {
    return utilsHandleDate(date)
}
